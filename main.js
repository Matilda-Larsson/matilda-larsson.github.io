(function () {
  // ── Project fragments to load ──
  var fragments = [
    'projects/bachelor-thesis.html',
    'projects/hall-bench.html',
    'projects/appdesign.html',
    'projects/plywood-stool.html',
    'projects/material-for-design.html',
    'projects/product-visualization.html'
  ];
  ...
  // ── Load project fragments then initialise overlays ──
  var overlayContent = document.querySelector('.overlay-content');

  if (overlayContent) {
    Promise.all(
      fragments.map(function (url) {
